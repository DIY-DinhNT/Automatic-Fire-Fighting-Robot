...
void loop() {
  ...
  if (FireInSide == "Fire_in_Right") {
    if (sensor_flame1 < 400) {
      Serial.println("Log for sensor 1: case 01");
      backward();
      openPump();
      servoTurnRight();
      notification(true, 1);
      ...
      Serial.println("Log for sensor 1: case 02");
      Stop();
      openPump();
      servoTurnRight();
      notification(true, 1);
      ...
      Serial.println("Log for sensor 1: case 03");
      onLed();
      closePump();
      turnRight();
      if (distanceCM <= 10) {
      ...
      Serial.println("Log for sensor 1: case 04");
      Stop();
      closePump();
      offLed();
    }
    ...
    Serial.println("Fire_in_Center codee");
    if (sensor_flame2 < 875) {
      Serial.println("Log for sensor 2: case 01");
      backward();
      openPump();
      servo2Direction();
      notification(true, 1);
      ...
      Serial.println("Log for sensor 2: case 02");
      Stop();
      openPump();
      servo2Direction();
      notification(true, 1);
      ...
      Serial.println("Log for sensor 2: case 03");
      onLed();
      closePump();
      if (distanceCM <= 10) {
        Stop();
      ...
      Serial.println("Log for sensor 2: case 04");
      Stop();
      closePump();
      offLed();
    }
    ...
    Serial.println("Fire_in_Left code");
    if (sensor_flame3 < 700) {
      Serial.println("Log for sensor 3: case 01");
      backward();
      openPump();
      servoTurnLeft();
      notification(true, 1);
      ...
      Serial.println("Log for sensor 3: case 02");
      Stop();
      openPump();
      servoTurnLeft();
      notification(true, 1);
      ...
      Serial.println("Log for sensor 3: case 03");
      onLed();
      closePump();
      turnLeft();
      if (distanceCM <= 10) {
      ...
      Serial.println("Log for sensor 3: case 04");
      Stop();
      closePump();
      offLed();
    }
